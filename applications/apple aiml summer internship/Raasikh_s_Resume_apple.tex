...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Emory University}{Atlanta, GA}
      \resumeItemListStart
        \resumeItem{Develop a scientific-contribution-aware literature review generation model by incorporating a RAG and GNN with 690,000+ papers and 10,000+ literature reviews, utilizing PyTorch and TensorFlow libraries.}
...
\section{Projects}
	...
	\resumeProjectHeading
          {\textbf{Museum Artifact Description Bias} $|$ \emph{Python, TensorFlow}}{June 2024 -- Present}
          \resumeItemListStart
      ...
      \resumeProjectHeading
          {\textbf{Gran Turismo 7 Predictor} $|$ \emph{Python, Scikit-learn, Swift}}{May 2024 -- Present}
          \resumeItemListStart
