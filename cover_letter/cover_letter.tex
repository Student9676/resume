...
%----------------------------------------------------------------------------------------
\setkomavar{fromname}{Raasikh Kanjiani} % Your name
\newkomavar{subtitle}\setkomavar{subtitle}{Undergraduate Computer Science Student} % Set the subtitle line for the first page header, leave empty for no subtitle

\setkomavar{fromaddress}{ } % Your address or location
\setkomavar{fromphone}{(404) 428-8533} % Your phone number
\setkomavar{fromemail}{raasikh.kanjiani@gmail.com} % Your email address
...
\setkomavar{subject}{General Mills Digital and Technology Internship Cover Letter} % Bold text above the letter specifying what it's for, useful for specifying the job you are applying for. Leave this empty for no subject.
